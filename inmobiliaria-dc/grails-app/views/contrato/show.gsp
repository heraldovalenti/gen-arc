		...
		<div id="show-contrato" class="content scaffold-show" role="main">
			...
			<ol class="property-list contrato">
				...
				<li class="fieldcontain">
					<span id="nro-contrato-label" class="property-label">
						<g:message code="com.hvalenti.freelance.inmobiliariaDC.Contrato.id.label" default="Nro Contrato" />
					</span>
					<span class="property-value" aria-labelledby="nro-contrato-label">${contratoInstance?.id}</span>
				</li>
