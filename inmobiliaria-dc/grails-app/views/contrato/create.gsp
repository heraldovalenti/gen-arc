...
<html>
	...
	<body>
		...
		<div id="create-contrato" class="content scaffold-create" role="main">
			...
			<g:hasErrors bean="${obligacionAlquiler}">
			<ul class="errors" role="alert">
				<g:eachError bean="${obligacionAlquiler}" var="error">
				<li <g:if test="${error in org.springframework.validation.FieldError}">data-field-id="${error.field}"</g:if>><g:message error="${error}"/></li>
				</g:eachError>
			</ul>
			</g:hasErrors>
			
			<g:hasErrors bean="${obligacionComision}">
			<ul class="errors" role="alert">
				<g:eachError bean="${obligacionComision}" var="error">
				<li <g:if test="${error in org.springframework.validation.FieldError}">data-field-id="${error.field}"</g:if>><g:message error="${error}"/></li>
				</g:eachError>
			</ul>
			</g:hasErrors>
			...
			<g:form url="[resource:contratoInstance, action:'save']" >
				<fieldset class="form">
					...
					<g:render template="obligaciones"/>
				</fieldset>
